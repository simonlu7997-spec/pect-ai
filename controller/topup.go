...
func GetTopUpInfo(c *gin.Context) {
	...
	enableWaffoPancakeRaw := isWaffoPancakeTopUpEnabled()
	// 前端 hasConfigurableTopup 不包含 enable_usdt_topup，无法重建前端
	// 故借道 enable_waffo_pancake_topup 标记让前端识别到充值入口
	enableWaffoPancake := enableWaffoPancakeRaw || enableUSDT
	if enableWaffoPancakeRaw {
